...
def find_faces(img):
    ...
    for k, d in enumerate(dets):
        ...
        shapes.append(shape)
    print("time find_faces used = ", datetime.now() - find_faces_now)
    return rects, shapes
...
def encode_faces(img, shapes):
    ...
    face_descriptors = []
    for s in shapes:
        encode_faces_now = datetime.now()
        face_descriptor = facerec.compute_face_descriptor(img, s)
        print("time compute_face_descriptor used = ", datetime.now() - encode_faces_now)
